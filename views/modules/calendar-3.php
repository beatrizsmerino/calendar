    ...
    <div class="c-page__item c-box">
        <form id="calendar3Save" action="" method="">
            <fieldset class="c-form__group">
                ...
                <input id="datepicker" class="c-form__field c-input" name="date" type="date" placeholder="dd/mm/yyyy" required/>
            </fieldset>
            ...
            <fieldset class="c-form__group">
                ...
                <label for="availability1" class="c-check">
                    <input id="availability1" class="c-check__input" name="availability" value="not-available" type="radio" required>
                ...
                <label for="availability2" class="c-check">
                    <input id="availability2" class="c-check__input" name="availability" value="low-availability" type="radio" required>
                ...
                <label for="availability3" class="c-check">
                    <input id="availability3" class="c-check__input" name="availability" value="available" type="radio" required>
